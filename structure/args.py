...
class Args:
    ...
    def __init__(self):
        ...
        self.num_graphs = 20000  # Set it None to take complete dataset
        ...
        self.load_model_path = 'model_save/DFScodeRNN_optc_h501_2025-12-17 08:50:14/DFScodeRNN_optc_h501_2980.dat'
        self.load_device = torch.device('cuda:1')
        self.epochs_end = 3000
