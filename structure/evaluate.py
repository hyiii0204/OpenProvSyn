...
class ArgsEvaluate():
    def __init__(self):
        ...
        self.model_path = 'model_save/DFScodeRNN_cadets_e3_2026-01-18 15:51:39/DFScodeRNN_cadets_e3_1060.dat'
        ...
        self.metric_eval_batch_size = 100
...
def patch_graph(graph):
    for u in graph.nodes():
        graph.nodes[u]['label'] = str(graph.nodes[u]['label']).split('-')[0]
...
def generate_graphs(eval_args):
    ...
    print(f"Graph generation completed in {elapsed_time:.2f} seconds.")
