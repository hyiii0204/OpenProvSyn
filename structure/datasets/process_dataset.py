...
def produce_provenance_graphs(base_path):
    graph_id = 0
    for i in tqdm(range(600)):
        G = nx.node_link_graph(json.load(open('{}{}.json'.format(base_path, str(i+1)))))
        ...
        for community in communities:
            ...
            if(len_edges > 10 and len_edges < 300 and nx.is_connected(subgraph) and graph_id < 200):
                with open(os.path.join(base_path, 'graphs/graph{}.dat'.format(graph_id)), 'wb') as f:
